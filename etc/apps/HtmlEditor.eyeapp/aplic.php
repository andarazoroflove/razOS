...
?>
<div align="center">
<APPLET CODEBASE="." ARCHIVE="kafenio.jar,gnu-regexp-1.1.4.jar,kafenio-config.jar,kafenio-icons.jar" CODE="de.xeinfach.kafenio.KafenioApplet.class" NAME="Kafenio" WIDTH="645" HEIGHT="400" MAYSCRIPT>
	<PARAM NAME="CODEBASE" VALUE="<?=$appinfo['appdir']?>">
	...
	<PARAM NAME="UNICODE" VALUE="true">
	<PARAM NAME="STYLESHEET" VALUE="styles2.css,kafenio.css">
	<PARAM NAME="LANGCODE" VALUE="en">
	<PARAM NAME="LANGCOUNTRY" VALUE="UK">
	...
	<PARAM NAME="MENUITEMS" VALUE="FILE,EDIT,VIEW,FONT,FORMAT,INSERT,TABLE,FORMS,SEARCH,TOOLS,HELP">
	<PARAM NAME="SERVLETURL" VALUE="http://<?=getenv(server_name)?><?=$dir?><?=$appinfo['appdir']?>images.php">
	<PARAM NAME="IMAGEDIR" VALUE="images/">
	<PARAM NAME="FILEDIR" VALUE="images/">
	<PARAM NAME="SERVLETMODE" VALUE="cgi">
	<PARAM NAME="SYSTEMID" VALUE="">
	<PARAM NAME="POSTCONTENTURL" VALUE="http://<?=getenv(server_name)?><?=$dir?><?=$appinfo['appdir']?>images.php">
